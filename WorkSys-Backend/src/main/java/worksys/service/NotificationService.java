...
import worksys.dto.NotificationDTO;
import worksys.entity.*;
import worksys.repository.*;
...
public class NotificationService {
    ...
    public void sendDeadlineReminders() {
        ...
        List<Task> tasks = taskRepository.findByDeadlineAndAssigneesIsNotEmptyAndStatusNotIn(
                tomorrow, doneStatuses);

        for (Task task : tasks) {
            for (User recipient : task.getAssignees()) {
